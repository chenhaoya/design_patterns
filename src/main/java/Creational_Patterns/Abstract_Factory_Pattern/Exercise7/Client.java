 ...
 * 说明：
 */
package Creational_Patterns.Abstract_Factory_Pattern.Exercise7;
...
public class Client {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Class<?> aClass = Class.forName("Creational_Patterns.Abstract_Factory_Pattern.Exercise7.ConcreateFactory.UNIX_Factory");
