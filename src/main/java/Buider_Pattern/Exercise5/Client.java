 ...
 * 说明：
 */
package Buider_Pattern.Exercise5;

import Buider_Pattern.Exercise5.Builder.Video_builder;
import Buider_Pattern.Exercise5.Director.Video_Controller;
import Buider_Pattern.Exercise5.Product.Video_play;

public class Client {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        Video_play video_play;
        Class<?> aClass = Class.forName("Buider_Pattern.Exercise5.Concrete_Builder.Memory_mode");
